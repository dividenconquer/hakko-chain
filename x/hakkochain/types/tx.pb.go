...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_5029fc278e0a2de4, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_5029fc278e0a2de4, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "hakkochain.hakkochain.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "hakkochain.hakkochain.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("hakkochain/hakkochain/tx.proto", fileDescriptor_5029fc278e0a2de4) }

var fileDescriptor_5029fc278e0a2de4 = []byte{
	// 322 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0xcb, 0x48, 0xcc, 0xce,
	0xce, 0x4f, 0xce, 0x48, 0xcc, 0xcc, 0xd3, 0x47, 0x62, 0x96, 0x54, 0xe8, 0x15, 0x14, 0xe5, 0x97,
	...
	0xd8, 0xc0, 0x71, 0x63, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x7c, 0x04, 0x49, 0x30, 0x55, 0x02,
	0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hakkochain.hakkochain.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hakkochain.hakkochain.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "hakkochain.hakkochain.Msg",
	...
	Metadata: "hakkochain/hakkochain/tx.proto",
}
